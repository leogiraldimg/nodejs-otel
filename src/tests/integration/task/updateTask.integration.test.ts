...
describe("Task::UpdateTask::integration", () => {
    ...
    beforeEach(async () => {
        ...
        const existingTask = await dsConnected
            .getRepository(TaskDataMapperTypeorm)
            .find({});
        existingTaskId = existingTask[0].id;
    });
    ...
    it("should return 200 and updated task", async () => {
        ...
        expect(response.json().message).toBe("Tarefa alterada com sucesso");
